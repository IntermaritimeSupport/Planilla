  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white px-6 py-8">
      <div className="max-w-3xl mx-auto bg-gray-800 border border-gray-700 rounded-xl p-6 space-y-6">
        <h1 className="text-2xl font-bold">{isEdit ? "Editar Compañía" : "Crear Compañía"}</h1>
        ...
        <InputNode label="RUC" value={formData.ruc} onChange={(value) => setFormData({ ...formData, ruc: value })} />
        ...
        <div className="flex gap-3 pt-4">
          <button onClick={() => navigate(-1)} className="flex-1 bg-gray-700 hover:bg-gray-600 py-2 rounded-lg">
            Cancelar
          </button>
          <button onClick={handleSave} className="flex-1 bg-blue-600 hover:bg-blue-700 py-2 rounded-lg">
            Guardar
          </button>
        </div>
      </div>
